...
import { useConversationList, useArchiveConversation } from "@/hooks/useConversations";
              ...
              <div key={conv.id}
                ...
                {hoveredConv === conv.id && (
                  <button
                    ...
                    className="shrink-0 mr-1.5 p-1 rounded-md text-zinc-500 hover:text-red-400 hover:bg-red-400/10 transition-colors disabled:opacity-40"
